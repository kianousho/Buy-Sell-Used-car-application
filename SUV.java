public class SUV extends Cars {
    ...
    public SUV(String make, String vinNumber, String model, double price, int year, double mileage,
            boolean slidingDoors, String cargoSpaceSize, String entertainmentSystem) {
